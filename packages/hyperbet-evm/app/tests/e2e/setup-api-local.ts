...
import { modelMarketIdFromCharacterId } from "../../../keeper/src/modelMarkets";
...
async function main(): Promise<void> {
  ...
  const primaryWallet = assertString(state.evmHeadlessAddress, "evmHeadlessAddress");
  const linkedWallet = "0x1000000000000000000000000000000000000001";
  const characterId = state.perpsCharacterId?.trim() || "e2e-model-alpha";
  const marketId =
