...
const EVM_SCENARIO_PRESETS: Omit<ScenarioPreset, "chainKey">[] = [
    ...
    {
        id: "restart-mid-fill",
        name: "Restart Mid Fill",
        family: "restart-recovery",
        description: "Restarts the MM after a partial fill and requires deterministic order/state recovery",
        enabledStrategies: ["market_maker", "retail", "cancel_replace"],
        defaultTicks: 6,
        defaultWinner: "A",
        canonicalSeed: "restart-mid-fill-seed-1",
        matrixSeeds: ["restart-mid-fill-seed-2"],
        tier: "gate",
        gatePolicy: {
            requireDegradationFree: true,
            requireMmSolvent: true,
            requireBookIntegrity: true,
            maxAttackerPnl: 0,
            maxStaleQuoteUptimeRatio: 0.15,
            maxOrphanOrderCount: 1,
            maxReconciliationLagMs: 750,
            maxUnresolvedClaimBacklog: 1,
        },
    },
    {
        id: "orphan-sweep-failure",
        name: "Orphan Sweep Failure",
        family: "orphan-cleanup",
        description: "Simulates cleanup drift and requires orphan orders to be quarantined and cleared",
        enabledStrategies: ["market_maker", "cancel_replace"],
        defaultTicks: 6,
        defaultWinner: "B",
        canonicalSeed: "orphan-sweep-seed-1",
        matrixSeeds: [],
        tier: "gate",
        gatePolicy: {
            requireDegradationFree: true,
            ...
            requireBookIntegrity: true,
            maxAttackerPnl: 0,
            maxOrphanOrderCount: 0,
            maxReconciliationLagMs: 650,
            maxUnresolvedClaimBacklog: 0,
        },
    },
    {
        id: "rpc-split-brain",
        name: "RPC Split Brain",
        family: "rpc-split-brain",
        description: "Split provider views must trigger stale halts and deterministic recovery",
        enabledStrategies: ["market_maker", "mev_frontrunner"],
        defaultTicks: 6,
        defaultWinner: "A",
        canonicalSeed: "rpc-split-brain-seed-1",
        matrixSeeds: [],
        tier: "gate",
        gatePolicy: {
            requireDegradationFree: true,
            ...
            requireBookIntegrity: true,
            maxAttackerPnl: 0,
            maxStaleQuoteUptimeRatio: 0.1,
            maxReconciliationLagMs: 700,
            maxUnresolvedClaimBacklog: 1,
        },
    },
    {
        id: "nonce-collision-replay",
        name: "Nonce Collision Replay",
        family: "nonce-collision",
        description: "Replays a pending nonce collision and requires persisted nonce recovery to stay fail closed",
        enabledStrategies: ["market_maker", "mev_frontrunner"],
        defaultTicks: 5,
        defaultWinner: "B",
        canonicalSeed: "nonce-collision-seed-1",
        matrixSeeds: [],
        tier: "gate",
        gatePolicy: {
            requireDegradationFree: true,
            ...
            maxAttackerPnl: 0,
            maxOrphanOrderCount: 0,
            maxReconciliationLagMs: 600,
            maxUnresolvedClaimBacklog: 0,
        },
    },
    {
        id: "reorg-finality-lag",
        name: "Reorg Finality Lag",
        family: "finality-lag",
        description: "Finality lag must halt stale quotes and preserve deterministic reconciliation",
        enabledStrategies: ["market_maker", "mev_frontrunner", "retail"],
        defaultTicks: 7,
        defaultWinner: "A",
        canonicalSeed: "reorg-finality-lag-seed-1",
        matrixSeeds: [],
        tier: "gate",
        gatePolicy: {
            requireDegradationFree: true,
    ...
    },
    {
        id: "rounding-abuse",
        name: "Rounding Abuse",
        family: "rounding-abuse",
        description: "Decimal edge cases should not leak attacker value or grow reconciliation debt",
        enabledStrategies: ["market_maker", "arbitrageur"],
        defaultTicks: 5,
        defaultWinner: "A",
        canonicalSeed: "rounding-abuse-seed-1",
        matrixSeeds: [],
        tier: "gate",
        gatePolicy: {
            requireDegradationFree: true,
    ...
    {
        id: "fee-token-depletion",
        name: "Fee Token Depletion",
        family: "fee-token-depletion",
        description: "Low fee-balance conditions must quarantine quoting and drain claim work deterministically",
        enabledStrategies: ["market_maker", "whale"],
        defaultTicks: 6,
        defaultWinner: "B",
        canonicalSeed: "fee-token-depletion-seed-1",
        matrixSeeds: [],
        tier: "gate",
        gatePolicy: {
            requireDegradationFree: true,
            ...
            requireBookIntegrity: true,
            maxAttackerPnl: 0,
            maxStaleQuoteUptimeRatio: 0.12,
            maxReconciliationLagMs: 650,
            maxUnresolvedClaimBacklog: 0,
        },
    },
    {
        id: "cross-market-inventory-bleed",
        name: "Cross Market Inventory Bleed",
        family: "inventory-bleed",
        description: "Inventory pressure from one market must not bleed across books without exposure caps",
        enabledStrategies: ["market_maker", "whale", "arbitrageur"],
        defaultTicks: 8,
        defaultWinner: "B",
        canonicalSeed: "inventory-bleed-seed-1",
        matrixSeeds: [],
        tier: "gate",
        gatePolicy: {
            requireDegradationFree: true,
