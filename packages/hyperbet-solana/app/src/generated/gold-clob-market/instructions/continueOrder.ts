...
export const CONTINUE_ORDER_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([52, 137, 158, 152, 162, 246, 203, 104]);
...
export type ContinueOrderInstructionDataArgs = { orderId: number | bigint;  };

export function getContinueOrderInstructionDataEncoder(): FixedSizeEncoder<ContinueOrderInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', fixEncoderSize(getBytesEncoder(), 8)], ['orderId', getU64Encoder()]]), (value) => ({ ...value, discriminator: CONTINUE_ORDER_DISCRIMINATOR }));
}

export function getContinueOrderInstructionDataDecoder(): FixedSizeDecoder<ContinueOrderInstructionData> {
    return getStructDecoder([['discriminator', fixDecoderSize(getBytesDecoder(), 8)], ['orderId', getU64Decoder()]]);
}

export function getContinueOrderInstructionDataCodec(): FixedSizeCodec<ContinueOrderInstructionDataArgs, ContinueOrderInstructionData> {
